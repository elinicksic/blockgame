...
bool rayToAABB(glm::vec3 pos, glm::vec3 vel, AABB box, glm::vec3 *point, glm::vec3 *normal) {
  ...
  float tmax = glm::min(glm::length(vel), glm::min(tbigger[0], glm::min(tbigger[1], tbigger[2])));
